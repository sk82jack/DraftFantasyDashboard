        ...
        New-UDColumn -SmallSize 12 -MediumSize 12 -LargeSize 8 -LargeOffset 2 -Endpoint {
            New-UDTabContainer -Tabs {
                New-UDTab -Text 'Current Season Stats' -Content {
                    New-UDChart -Title 'Total League Points by League' -Type Bar -Endpoint {
                    ...
                    New-UDChart -Title 'Top 10 Total League Points' -Type HorizontalBar -Endpoint {
                    ...
                    New-UDChart -Title 'Top 10 Total League Points Against' -Type HorizontalBar -Endpoint {
